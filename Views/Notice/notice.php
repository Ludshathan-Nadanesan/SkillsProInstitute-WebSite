...
<body>
                    ...
                    echo "<script>console.log(" . json_encode($e) . ");</script>"; ?>
                        ...
                        >
                            <div class="event-content">
                                ...
                                <p class="event-date">📅 <?= htmlspecialchars($e['start_date']).' - '.htmlspecialchars($e['end_date']); ?></p>
                                <p class="event-location">📍 SkillPro <?= htmlspecialchars($e['branch']); ?> Branch</p>
                                <p class="event-short"><?php
                                    if (strlen($e['content']) > 45) {
                                        $short_description = substr($e['content'], 0, 45) . '...';
                                    } else {
                                        $short_description = $e['content'];
                                    }
    ...
    <script src="notice-script.js"></script>
</body>
</html>